...
public class UserController {
    ...
    @PostMapping("/users")
    public Response<PageVo<SysUser>> pageInfo(@RequestBody @Valid UserPageReqVo userPageReqVo){
    ...
    public Response<String> updatePassword(@RequestBody @Valid UserUpdatePasswordReqVo userUpdatePasswordReqVo, HttpServletRequest request){
        String accessToken = request.getHeader(Constant.ACCESS_TOKEN);
        String refreshToken = request.getHeader(Constant.REFRESH_TOKEN);
        return userService.userUpdatePassword(userUpdatePasswordReqVo,accessToken,refreshToken);
    }
}